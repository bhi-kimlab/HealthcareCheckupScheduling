...
# args for env
parser.add_argument('--n_p', type=int, default=50, help='Number of patients of instance')
parser.add_argument('--n_tr', type=int, default=10, help='Number of sampleing for search')
parser.add_argument('--n_s', type=int, default=10, help='Number of stations instance')
...
parser.add_argument('--print_log', type=bool, default=False, help='print log flag')
parser.add_argument('--test', type=bool, default=False, help='only one vali data')
parser.add_argument('--train', type=str, default="snuh", help='only one vali data')
parser.add_argument('--vali', type=str, default="snuh", help='only one vali data')
parser.add_argument('--log_dir', type=str, default="log/", help='only one vali data')

parser.add_argument('--lr_name', type=int, default=1, help='lr')
parser.add_argument('--reward', type=str, default="sec", help='lr')
parser.add_argument('--no_cap', type=bool, default=False, help='lr')


## for evaluation

parser.add_argument('--log_time', type=str, default=0, help='lr')
parser.add_argument('--vali_model', type=int, default=1, help='lr')
